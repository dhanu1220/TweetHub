...
function Sidebar({ handleLogout, user }) {
  ...
  return (
    ...
    <div className="sidebar">
      ...
      <CustomeLink to='/home/content'>
        <SidebarOptions Icon={EditNoteIcon} text="Content" />
      </CustomeLink>
      <CustomeLink to='/home/question'>
        <SidebarOptions Icon={QuestionAnswerIcon} text="Question" />
      </CustomeLink>
